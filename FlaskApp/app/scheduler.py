...
class UrlScheduler:
    ...
    def __init__(self):
        ...
        self.url_jobs = [
            UrlJob(url="https://dynalist.io/d/wZS0cJaYail7hztlLrtqFkHI", job_id="target_job"),
            UrlJob(url="https://tenki.jp/forecast/3/15/4510/12203/1hour.html", job_id="weather_job"),
            UrlJob(url="https://x.com/search?q=list%3A1806588612156465555%20filter%3Aimages%20min_faves%3A100&src=recent_search_click&f=live", job_id="illust_job")
        ]
        ...
        self.add_job(
            ...
            args=[r"C:\Users\user\PycharmProjects\MyUtilProject\MyApp\bat\getWeatherData.bat"],
            trigger='cron',
            hour=23,
            minute=0,
        ...
        self.add_job(
            func=subprocess.Popen,
            args=[r"C:\Users\user\PycharmProjects\MyUtilProject\MyApp\bat\getYlArchive.bat"],
            trigger='cron',
            hour=19,
            minute=0,
